...
echo ""
echo -e "${YELLOW}1️⃣  Entrar no diretório dos arquivos:${NC}"
echo "   cd /opt/n8n-standby"
echo ""
echo -e "${YELLOW}2️⃣  Executar configuração completa:${NC}"
echo "   sudo ./setup-standby.sh"
echo ""
echo -e "${YELLOW}3️⃣  Ou configurar manualmente:${NC}"
...
echo ""
echo -e "${YELLOW}💡 Dica: Os arquivos estão em /opt/n8n-standby${NC}"
echo ""
